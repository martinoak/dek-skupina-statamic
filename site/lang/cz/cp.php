...
return [
    ...
    'sneak_peek' => 'Živý náhled',
    'sneak_peeking' => 'Živý náhled',
    'view_site' => 'Zobrazit stránku',
    'visit_url' => 'Navštívít URL',
    'search_for_anything' => 'Vyhledat cokoli',

    // Pages
    'page' => 'Stránka',
    'pages' => 'Stránka|Stránky',
    'nav_pages' => 'Stránky',
    'create_page_button' => 'Vytvořit stránku',
    'edit_homepage_button' => 'Upravit Homepage',
    'create_page' => 'Vytvořit novou stránku',
    'page_created' => 'Stránka vytvořena',
    'editing_page' => 'Úprava stránky',
    'page_updated' => 'Stránka upravena',
    'home' => 'Domů',
    'show_urls' => 'Zobrazit URL adresy',
    'show_titles' => 'Zobrazit titulky stránek',
    'choose_page_type' => 'Vyber typ stránky',
    'parent_page' => 'Rodičovská stránka',
    'pages_reordered' => 'Stránky úspěšně přeorganizovány.',

    // Collections
    'collections' => 'Kolekce|Kolekce',
    'nav_collections' => 'Kolekce',
    'manage_collections' => 'Spravovat kolekce',
    'create_collection_button' => 'Vytvořit kolekci',
    'create_collection' => 'Vytvořit novou kolekci',
    'collection_created' => ':title vutvořeno',
    'editing_collection' => 'Úprava :collection',
    'collection_updated' => ':title upraveno',
    'collections_empty' => 'Kolekce jsou kontejnery, ve kterých jsou uloženy skupiny podobných záznamů, všechny se stejným vzorem adresy URL.',
    'collection_title_instructions' => 'Vlastní název vaší kolekce.',
    'collection_handle_instructions' => "Název proměnné této kolekce, použitelný v nastavení a šablonách (písmena anglické abecedy, čísla a podtržítko \"_\" )",
    'collection_order_instructions' => "Nastavte výchozí řazení pro výpis položek této kolekce",
    'collection_fieldset_instructions' => "Výchozí fieldset, pokud není uvedeno jinak.",  // !
    'collection_template_instructions' => "Výchozí šablona, pokud není uvedeno jinak.",
    'collection_route_instructions' => "The route controls the URL pattern all entries in the collection will follow.",  // !
    'collection_does_not_exist' => 'Kolekce :collection neexistuje.',

    // Entries
    'entry' => 'Záznam',
    'entries' => 'Záznam|Záznamy',
    'nav_entries' => 'Záznamy',
    'create_entry_button' => 'Vytvořit záznam',
    'create_entry' => 'Nová položka', /*'Nový :noun',*/
    'entry_created' => 'Záznam vyvtořen',
    'editing_entry' => 'Úprava záznamu',
    'entry_updated' => 'Záznam upraven',
    'entries_empty_heading' => ':type Entries',  // !
    'entries_empty' => 'Záznamy jsou kousky obsahu, které mají svou vlastní adresu URL a často se zobrazují v seznamech, jako jsou příspěvky do blogů, novinky a události.',

    // Taxonomies
    'taxonomy' => 'Taxonomie',
    'taxonomies' => 'Taxonomie|Taxonomie',
    'nav_taxonomies' => 'Taxonomie',
    'create_taxonomy' => 'Vytvořit novou taxonomii',
    'create_taxonomy_button' => 'Vytvořit taxonomii',
    'manage_taxonomies' => 'Spravovat taxonomie',
    'editing_taxonomy' => 'Úprava taxonomie',
    'taxonomy_updated' => 'Taxonomie upravena',
    'taxonomy_created' => 'Taxonomie vytvořena',
    'taxonomies_empty_heading' => 'Taxonomie',
    ...
    'assets' => 'Médium|Média',
    'nav_assets' => 'Média',
    'new_asset' => 'Nové Médium',
    'add_asset' => 'Přidat Médium',
    'browse_assets' => 'Procházet Média',
    'browsing_assets' => 'Procházení Médií',
    'creating_asset' => 'Tvorba Média',
    'asset_created' => 'Médium Vytvořeno',
    'editing_asset' => 'Úprava Média',
    'asset_updated' => 'Médium Aktualizováno',
    'drop_to_upload' => 'Drop to Upload',
    'upload_asset' => 'Nahrát Médium',
    'sync_assets' => 'Synchronizovat Média',
    'syncing_assets' => 'Synchronizování Médií',
    ...
    'asset_folder_empty_heading' => 'Prázdná Složka',
    'asset_folder_empty' => 'Nahrajte Soubry Přetažením Do Této Oblasti',
    'focal_point' => 'Ústřední bod',
    'focal_point_label' => 'Klikněte na obrázek pro přidání ústředního/hlavního bodu',
    'focal_point_instructions' => 'Ústřední bod je používán během ořezávání, tak aby hlavní oblast zůstala v centru.',
    'or_drag_and_drop_files' => 'nebo sem přetáhněte soubory.',
    'no_asset_container_specified' => 'No asset container specified.',
    'rename_file' => 'Přejmenovat Soubor',
    'rename_file_warning' => 'Přejmenováním souboru se neupraví reference k souborům. To _může_ mít za následek nefungování odkazů na vašich stránkách.',
    'move_file' => 'Přesunout Soubor',
    'move_file_warning' => 'Přesunutím souboru se neupraví reference k souborům. To _může_ mít za následek nefungování odkazů na vašich stránkách.',
    'dimensions' => 'Dimensions',
    'last_modified' => 'Poslední Úprava',
    'url_resolves_to' => 'URL odpovídá: :path',
   // 'url_resolves_to' => 'URL resolves to: :path',


    // Folder
    'folder_title_instructions' => 'Název složky pro zobrazení v administraci',
    'folder_directory_instructions' => 'Název složky v systému',
    ...
    // Set Builder
    'add_set' => 'Přidat Set',
    'edit_set' => 'Upravit Set',
    'delete_set' => 'Smazat Set',
    'toggle_sets' => 'Přepnout Sety',
    'set_fields_instructions' => "Vyberte pole tohoto setu",
    ...
    'create_user_button' => 'Vytvořit Uživatele',
    'create_user' => 'Vytvořit Uživatele',
    'create_a_user' => 'Vytvořit Uživatele',
    'user_created' => 'Uživatel Vytvořen',
    'editing_user' => 'Úprava Uživatele',
    'user_updated' => 'Uživatel Upraven',
    'reset_password' => 'Resetovat Heslo',
    'choose_new_password' => 'Nastavit Nové Heslo',
    'new_password' => 'Nové Heslo',
    'change_password' => 'Změnit Heslo',
    'send_email' => 'Poslat E-mail',
    'email_sent' => 'E-mail Odeslán',
    'send_activation_email' => 'Poslat Aktivační E-mail',
    'send_password_reset_email' => 'Poslat E-mail Pro Resetování Hesla',
    'password_reset_email_not_sent' => 'E-mail nešlo odeslat. Prosím zkontrolujte hlášení o chybách (logs)',
    'copy_activation_link' => 'Kopírovat Aktivační Odkaz',
    'copy_password_reset_link' => 'Kopírovat Odkaz Pro Resetování Hesla',
    'copy_password_reset_link_failed' => 'Odkaz nešlo vygenerovat. Prosím zkontrolujte hlášení o chybách (logs)',
    'password_reset_sent' => 'E-mail pro resetování hesla odeslán',
    'account_activated' => 'Váš účet byl aktivován',
    'password_reset_success' => 'Vaše heslo bylo resetováno',
    'activate_account' => 'Aktivovat Účet',
    'account' => 'Účet',
    'password' => 'Heslo',
    'password_for' => 'Heslo pro :username',
    'my_account' => 'Můj účet',
    'profile' => 'Profil',
    'logout' => 'Odhlásit se',
    'sign_out' => 'Odhlásit se',
    'user_options' => 'Nastavení Uživatele',
    'user_bio_instructions' => 'Něco o Vás - pokud chcete.',
    'user_account_created' => 'Účet byl vytvořen',
    'forgot_password' => 'Zapomněl jste své heslo?',
    'invalid_user' => 'Neplatný uživatel',
    'invalid_code' => 'Neplatný kód',
    'invalid_creds' => 'Neplatné údaje',
    'go_back' => 'Zpět',

    // Password Reset
    'reset_code_missing' => 'Kód nebyl nalezen.',
    'reset_code_invalid' => 'Neplatný kód',

    // Roles
    'roles' => 'Role|Role',
    'nav_user-roles' => 'Uživatelské Role',
    'create_role_button' => 'Vytvořit Roli',
    'creating_role' => 'Tvorba Role',
    'role_created' => 'Role Vytvořena',
    'editing_role' => 'Úprava Role',
    'role_updated' => 'Role byla Upravena',
    'roles_empty_heading' => 'Role Uživatelů',
    'roles_empty' => 'Uživatelské Role Vám umožní přidělit několik oprávnění pod jednou značkou. Například Editor, Publicista, Správce.',

    // Permissions
    'permissions' => 'Oprávnění|Oprávnění',
    'access' => 'Přístup',
    'checking_folder_permissions' => 'Kontrola složky s oprávněními, prosím počkejte...',
    'folders_permission_valid' => 'Složka a soubor s oprávněními vypadá v pořádku',
    'folders_unwritable' => 'The following directories need to be writable:',

    // Error Pages
    'error' => 'Error',
    'permission_denied' => 'Přístup Odepřen',
    'permission_denied_instructions' => "Nemáte dostatečná oprávnění.",
    'page_not_found' => 'Stránka nebyla nalezena',
    'page_not_found_instructions' => 'Stránka, kterou jste hledali neexistuje',
    ...
    'publish_error' => 'Došlo problému při ukládání Vašich dat, více informací najdete v hlášení o chybách(logs)',
    ...
    'settings_cp' => 'Ovládací Panel',
    'settings_routes' => 'Cesty',
    'settings_search' => 'Vyhledávání',
    'settings_system' => 'System',
    'settings_assets' => 'Média',
    'settings_caching' => 'Mezipaměť',
    'settings_debug' => 'Ladění',
    'settings_email' => 'E-mail',
    'settings_theming' => 'Témata',
    'settings_users' => 'Uživatelé',
    'settings_updated' => 'Nastavení uloženo',
    'settings_updated_and_indexed' => 'Nastavení uloženo a indexy pro vyhledávání upraveny.',
    'settings_locales_instructions' => "You can skip this for now and do it later if you'd prefer.",
    ...
    'shorthand' => 'Zkratka',
    'shorthand_instructions' => 'Jazyky – dvoupísmenné kódy a názvy<br> Example: `en`, `de`.',
    ...
    // Addons
    'addons' => 'Doplněk|Doplňky',
    'manage_addons' => 'Správa Doplňků',
    'nav_addons' => 'Doplňky',
    'addons_empty_heading' => 'Nemáte žádné doplňky',
    'addons_empty' => 'Doplňky rozšiřují funkce Statamicu',
